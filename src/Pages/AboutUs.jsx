    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <section className="max-w-5xl mx-auto px-6 text-center mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-16">
          <img
            src="https://img.freepik.com/free-photo/woman-tailor-working-sewing-factory_1303-15841.jpg?semt=ais_incoming&w=740&q=80"
            alt="Workplace"
            className="rounded-sm w-full h-[400px] object-cover"
          />
          <div className="grid grid-rows-2 gap-4">
            <img
              src="https://cloudbooking.com/wp-content/uploads/2023/02/workplace-vs-workspace.jpeg"
              alt="Sewing"
